...
public class TransactionAccount implements Serializable{
	...
	private TransactionClientAccount lancamentoContaCorrenteCliente;
	...
	public TransactionAccount(){
		this.lancamentoContaCorrenteCliente = new TransactionClientAccount();
		this.numeroEvento = 0;
		this.quantidadeLancamentoRemessa = 0;
		this.valorLancamentoRemessa = 0.0;
	 ...
	 */
	public TransactionClientAccount getLancamentoContaCorrenteCliente() {
	...
	public void setLancamentoContaCorrenteCliente(
			TransactionClientAccount lancamentoContaCorrenteCliente) {
